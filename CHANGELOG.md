...
- **Changed:** Restored the `openvino==2025.4.1` baseline pin to ensure Intel GPU hardware detection remains compatible with the container's OpenCL drivers, avoiding the broken device detection found in the 2026.x series.

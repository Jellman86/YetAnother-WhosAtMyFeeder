...
- [ ] Release `model_config.json` sidecars were regenerated from `REMOTE_REGISTRY`; globally safe
  and host-gated candidate provider lists match the reviewed compatibility evidence.

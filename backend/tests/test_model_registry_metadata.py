...
async def test_available_models_expose_tiered_metadata():
    ...
    assert by_id["medium_birds"].region_variants["na"]["preprocessing"]["resize_mode"] == "center_crop"
    assert by_id["medium_birds"].region_variants["na"]["preprocessing"]["crop_pct"] == pytest.approx(0.875)

...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("GET", "/api/frigate/1788686951.128889-si0jon/hls/master.m3u8", True),
        ("GET", "/api/frigate/1788686951.128889-si0jon/hls/seg-1-v1-a1.m4s", True),
        ("GET", "/api/frigate/1788686951.128889-si0jon/recording-hls/master.m3u8", True),
        ...
        ("POST", "/api/frigate/1788686951.128889-si0jon/hls/master.m3u8", False),

...
def rank_video_top_frames(
    ...
    *,
    ...
    known_frames = [frame for frame in frame_scores if not should_hide_species_label(frame.get("top_label"))]
    ...
    return [
        {**frame, "rank": rank, "clip_variant": clip_variant} for rank, frame in enumerate(sorted_frames[:limit], 1)
    ]

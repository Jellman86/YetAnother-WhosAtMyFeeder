...
<ErrorBoundary>
  ...
  {:else}
      ...
      <div class="flex-1 flex flex-col transition-all duration-300 {effectiveLayout === 'vertical' ? (isSidebarCollapsed ? 'md:pl-20' : 'md:pl-64') : ''} {isMobile ? 'pb-16' : ''}">
      ...
      <BottomNav {currentRoute} onNavigate={navigate} {navItems} />
  {/if}

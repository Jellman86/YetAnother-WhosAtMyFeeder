...
const REQUIRED_KEYS = [
    ...
    'settings.data.purge_missing_clips',
    'settings.data.purge_missing_snapshots',
    'settings.data.purge_missing_clips_confirm',
    'settings.data.purge_missing_snapshots_confirm',

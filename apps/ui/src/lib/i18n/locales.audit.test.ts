...
const REQUIRED_ACTIVE_KEYS = [
    ...
    'detection.card_analysis.finalizing',
    'detection.card_analysis.finalizing_subtitle',
    'detection.card_analysis.snapshot_subtitle',
    'detection.card_analysis.title',
    'detection.card_analysis.video_subtitle',
...
const MUST_BE_LOCALIZED = [
    ...
    'settings.telemetry.health_title',
    'settings.telemetry.health_desc',
    'settings.telemetry.health_includes',
    'settings.telemetry.health_includes_value',
    ...
    'settings.integrations.birdnet.add_detected_source',
    'settings.integrations.birdnet.add_detected_source_label',
    'settings.integrations.birdnet.source_token_list_label',
    'settings.integrations.birdnet.source_token_remove',
    ...
    'settings.enrichment.fallback_note',

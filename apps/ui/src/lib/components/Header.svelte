<script lang="ts">
    ...
    const allNavItems = $derived.by(() => ([
        ...
        { path: '/observations/new', label: $_('nav.add_observation', { default: 'Add observation' }), icon: 'M12 16V4m0 0L8 8m4-4 4 4M5 14v4a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2v-4', requiresAuth: true },

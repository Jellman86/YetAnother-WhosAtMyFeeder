    ...
    theme: {
        extend: {
            colors: {
                ...
                // Semantic success — deliberately NOT theme-driven. `accent` is a
                // brand colour and the bluetit theme paints it amber, which is
                // reserved for "needs a person" (layout-patterns.md §1.3).
                success: {

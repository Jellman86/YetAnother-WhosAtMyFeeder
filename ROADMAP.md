...
- 🔄 **Backend endpoint contracts** — review started with authentication action responses; remaining
  JSON endpoints are being separated from intentional streaming/file/redirect responses and typed.
